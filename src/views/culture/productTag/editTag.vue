<template>
	<div>
		<el-form ref="dataForm" class="tagForm" :model="dataForm" label-width="120px" :rules="rules" v-loading="loadingFrom">
			<el-form-item label="标签名称：" prop="tagName">
				<el-input v-model.trim="dataForm.tagName" type="text" placeholder="请输入标签名称" maxLength="5" :disabled="dataForm.owner === 0" />
			</el-form-item>
			<el-form-item label="标签说明：" prop="tagNote">
				<el-input v-model.trim="dataForm.tagNote" type="textarea" placeholder="请输入标签说明" :disabled="dataForm.owner === 0" />
			</el-form-item>
			...
			<el-form-item>
				...
				<el-button type="primary" :loading="loading" @click="onsubmit('dataForm')">保存 </el-button>
				<!--        </span>-->
			</el-form-item>
		</el-form>
	</div>
...
<script>
import * as storeApi from '/@/api/culture/product/product.ts';
