<template>
	<el-dialog v-model="modals" title="发货" :before-close="cancel" width="800px">
		<el-form ref="formItemRef" :model="formItem" label-width="100px" @submit.native.prevent :rules="rules">
			...
			<el-form-item label="快递公司：" prop="expressCode">
				<el-select v-model="formItem.expressCode" filterable clearable>
		...
		<template #footer>
			<el-button @click="cancel(formItemRef)">取消</el-button>
