...
import { delContent, contentPage, contentSequence, updateArticleStatus, searchParamsAllChannel } from '/@/api/culture/contentCenter';
...
const toEdit = (id?: string) => {
	router.push({
		path: '/culture/contentCenter/edit',
		query: { id },
	});
};
