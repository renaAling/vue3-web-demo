<template>
	<div class="entrance-dialog-container">
		<el-dialog :close-on-click-modal="false" :title="dataForm.id ? '编辑栏目' : '新增栏目'" draggable v-model="visible">
...
import { addChannel, channelDetail, updateChannel } from '/@/api/culture/contentCenter';
