<template>
	<el-dialog title="被分销人列表" v-model="dialogVisible" :close-on-click-modal="false" :show-close="false" width="80%">
		<el-card>
			<el-form :model="state.queryForm" ref="queryRef" :inline="true" @keyup.enter="getDataList">
				...
				<el-form-item label="关键字" prop="keywords">
					<el-input v-model="state.queryForm.keywords" placeholder="请输入用户昵称、电话、UID" maxlength="50" />
				</el-form-item>
				<el-form-item>
			...
			<el-table border :data="state.dataList" v-loading="state.loading" style="width: 100%" :cell-style="tableStyle.cellStyle" :header-cell-style="tableStyle.headerCellStyle" row-key="id">
				...
				<el-table-column prop="spreadCount" label="分销人数"></el-table-column>
			</el-table>
...
import { subList } from '/@/api/member/distributor'
