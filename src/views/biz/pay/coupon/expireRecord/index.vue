	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			<el-row class="ml10" v-show="showSearch">
				<el-form :inline="true" :model="state.queryForm" @keyup.enter="search" ref="queryRef">
					<el-col :span="24">
						...
						<el-form-item label="过期平台" prop="issuingPlatformType">
							<el-select placeholder="请选择过期平台" style="width: 180px" clearable v-model="state.queryForm.issuingPlatformType">
								<el-option :key="item.value" :label="item.label" :value="item.value" v-for="item in typeLists" />
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="过期时间" prop="roleName">
							<date-compents
								ref="createDate"
								@getDate="(val) => ([state.queryForm.expirationStartTime, state.queryForm.expirationEndTime] = val)"
							></date-compents>
						</el-form-item>
						<el-form-item>
			...
			>
				...
				<el-table-column label="过期平台" prop="issuingPlatformTypeName" show-overflow-tooltip />
