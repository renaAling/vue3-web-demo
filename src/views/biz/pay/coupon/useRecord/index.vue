	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			<el-row class="ml10" v-show="showSearch">
				<el-form :inline="true" :model="state.queryForm" @keyup.enter="search" ref="queryRef">
					<el-col :span="24">
						...
						<el-form-item label="使用平台" prop="issuingPlatformType">
							<el-select placeholder="请选择使用平台" style="width: 180px" clearable v-model="state.queryForm.issuingPlatformType">
								<el-option :key="item.value" :label="item.label" :value="item.value" v-for="item in typeLists" />
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="使用时间" prop="roleName">
							<date-compents
								ref="createDate"
								@getDate="(val) => ([state.queryForm.usageStartTime, state.queryForm.usageEndTime] = val)"
							></date-compents>
						</el-form-item>
						<el-form-item>
			...
			>
				...
				<el-table-column label="使用平台" prop="issuingPlatformTypeName" show-overflow-tooltip />
				<el-table-column label="使用时间" prop="usageTime" show-overflow-tooltip />
			</el-table>
