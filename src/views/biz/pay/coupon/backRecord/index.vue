	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			<el-row class="ml10" v-show="showSearch">
				<el-form :inline="true" :model="state.queryForm" @keyup.enter="search" ref="queryRef">
					<el-col :span="24">
						...
						<el-form-item label="回退平台" prop="issuingPlatformType">
							<el-select placeholder="请选择回退平台" style="width: 180px" clearable v-model="state.queryForm.issuingPlatformType">
								<el-option :key="item.value" :label="item.label" :value="item.value" v-for="item in typeLists" />
							</el-select>
						</el-form-item>
					</el-col>
					<el-col :span="24">
						<el-form-item label="回退时间" prop="roleName">
							<date-compents
								ref="createDate"
								@getDate="(val) => ([state.queryForm.rollbackStartTime, state.queryForm.rollbackEndTime] = val)"
							></date-compents>
						</el-form-item>
						<el-form-item>
			...
			>
				...
				<el-table-column label="绑定手机号" prop="mobile" show-overflow-tooltip />
				<el-table-column label="卡券编码" prop="couponCode" show-overflow-tooltip />
				<el-table-column label="卡券金额(元)" prop="amount" show-overflow-tooltip />
				<el-table-column label="回退平台" prop="issuingPlatformTypeName" show-overflow-tooltip />
				<el-table-column label="回退时间" prop="rollbackTime" show-overflow-tooltip />
			</el-table>
