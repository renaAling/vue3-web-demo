...
import { fetchRoleList, getStoreList, saveOrUpdateStaffInfo, staffDetail, fetchMerchantList } from '/@/api/goodStore/staff';
...
const openMerchantDialog = async () => {
	state.queryForm.merchantCode = Session.get('merchantCode');
