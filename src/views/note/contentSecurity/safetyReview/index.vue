	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			...
			>
				...
				<el-table-column type="" label="操作" width="150" show-overflow-tooltip>
					<template #default="scope">
						<div class="flex justify-center">
							<el-button type="primary" link @click="handleLook(scope.row)">
								{{ scope.row.status == 2 ? '审核' : '查看' }}
							</el-button>
						</div>
					</template>
				</el-table-column>
...
const handleLook = (row: any) => {
	router.push({
		path: '/note/contentSecurity/safetyReview/review',
		query: { id: row.id },
	});
};
