	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			<el-row class="justify-between">
				<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList" ref="queryRef">
					...
					<el-form-item>
						...
						<el-button @click="handleApply" type="primary">发起申请</el-button>
					</el-form-item>
				</el-form>
			</el-row>
			<el-table
			...
			>
				...
				<el-table-column prop="startTime" label="申请投放时间">
					<template #default="scope">
						<span>{{ dayjs(scope.row.startTime).format('YYYY-MM-DD') }}</span>
					</template>
				</el-table-column>
				<el-table-column prop="createTime" label="申请时间" />
				<el-table-column prop="applyUserId" label="申请账号ID" />
...
const handleApply = () => {
	router.push('/ad/advertisingRelease/form');
};
