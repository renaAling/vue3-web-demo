	...
	<div class="layout-padding" style="width: 100%">
		<div>
			...
			<div style="overflow: hidden">
				...
				<passengerMileagePoints ref="passengerMileagePointsRef" :unionId="userUnionId" v-if="activeName == '2'"></passengerMileagePoints>
			</div>
		</div>
...
const toForward = () => {
	activeName.value = '1';
	router.push('/travel/personalInformation/userinfo/index');
};
