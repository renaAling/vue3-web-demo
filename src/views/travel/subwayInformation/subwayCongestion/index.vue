			...
			<el-row shadow="hover" class="ml10">
				<el-form :model="form" ref="queryRef" :inline="true">
					<el-form-item label="URL" prop="interfaceUrl">
						<el-input placeholder="请输入列车拥挤度详情页面url" style="width: 500px" v-model="form.interfaceUrl" clearable :disabled="!isEdit"/>
					</el-form-item>
					<el-form-item>
						<!-- <el-button type="primary" @click="getSee">查看</el-button> -->
...
const form = ref<any>({
	type: 4, // 接口类型：1.列车运行表、2.列车时刻表、3.列车运行实时信息、4.列车拥挤详情、5.强冷强弱 6.出战信息图
	id: '',
	interfaceUrl: '',
});
const iframeUrl = ref();
