			...
			<el-row>
				<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList" ref="queryRef">
					<el-form-item label="渠道" prop="channelName">
						<el-input placeholder="请输入渠道名称查询" v-model="state.queryForm.channelName" clearable max-length="200" />
					</el-form-item>
					<el-form-item>
...
<script lang="ts" setup name="good-store-reportForms-reconciliation">
import { BasicTableProps, useTable } from '/@/hooks/table';
import { merchantReportPage } from '/@/api/goodStore/reportForm';
const queryRef = ref();
const state: BasicTableProps = reactive<BasicTableProps>({
	pageList: merchantReportPage,
	queryForm: {
		channelName: '',
	},
	dataList: [],
