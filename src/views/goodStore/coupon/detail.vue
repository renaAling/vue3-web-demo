<template>
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			...
			>
				<el-table-column prop="couponName" label="发放优惠券名称" show-overflow-tooltip></el-table-column>
				...
				<el-table-column prop="distributeNum" label="发放张数" ></el-table-column>
			</el-table>
...
import { couponSubDetail } from '/@/api/goodStore/coupon';
const queryRef = ref();
const showSearch = ref(true);
const route = useRoute();
onMounted(() => {
	if(route.query?.issueCode)
	state.queryForm.distributeCode = route.query?.issueCode
});
const state: BasicTableProps = reactive<BasicTableProps>({
	queryForm: {},
	pageList: couponSubDetail, // H
	descs: ['create_time'],
});
// 清空搜索条件
const resetQuery = () => {
