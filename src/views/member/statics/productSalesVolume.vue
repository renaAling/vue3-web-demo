	...
	<div class="layout-padding">
		<div class="layout-padding-auto layout-padding-view">
			<el-row class="justify-between">
				<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList" ref="queryRef">
					<el-row>
						...
						<el-form-item label="所属业务" prop="businessType" label-width="68px">
			...
			>
				...
				<el-table-column label="销量排名" prop="sort" />
				<el-table-column label="商品名称" prop="productName" />
				<el-table-column label="所属业务" prop="businessType">
				...
				<el-table-column label="商品售价" prop="payPrices" />
				<el-table-column label="销量总数" prop="payNum" />
				<el-table-column label="分销销量" prop="distributeNum" />
			</el-table>
...
<script lang="ts" setup name="productSalesVolume">
import { BasicTableProps, useTable } from '/@/hooks/table';
import { areaListForSale, salePage } from '/@/api/member/statics';
...
// 获取行政区树形结构数据
const getTree = async () => {
	let res = await areaListForSale({ type: state.queryForm.type });
...
const exportExcel = async () => {
	...
	downBlobFile('/uac/sale/sort/report/export', params, '会员商品销量统计报表.xlsx');
};
