<template>
		...
		<div class="layout-padding" style="width: 100%">
			<div class="layout-padding-auto layout-padding-view">
				...
				>
					...
					<el-table-column label="规则详情" prop="pushRule" />
					...
					<el-table-column label="推送时机" prop="pushMoment" />
					<el-table-column label="操作">
						<template #default="{ row }">
							<el-button type="primary" link @click="formDialogRef.openDialog(row)">查看</el-button>
							<el-button type="primary" link @click="tableDialogRef.openDialog(row)">推送日志</el-button>
						</template>
					</el-table-column>
				</el-table>
	...
	<tableDialog ref="tableDialogRef" @refresh="getDataList"></tableDialog>
</template>
...
const addFormDialog = defineAsyncComponent(() => import('./addForm.vue'));
const tableDialog = defineAsyncComponent(() => import('./tableDialog.vue'));
...
// formatter 函数
const formatPushTarget = (row: any) => {
	const target = row.pushTarget;
	if (!target) return '--';
