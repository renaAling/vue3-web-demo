		...
		<div class="layout-padding" style="width: 100%">
			<div class="layout-padding-auto layout-padding-view">
					...
					<el-form :inline="true" :model="state.queryForm" @keyup.enter="getDataList" ref="queryRef">
						...
						<el-form-item label="状态" prop="userState" placeholder="请选择状态">
							<el-select v-model="state.queryForm.userState" clearable style="width: 180px">
								...
								<!-- <el-option label="获取" :value="1">获取</el-option>
								<el-option label="消耗" :value="2">消耗</el-option>
								<el-option label="失效" :value="3">失效</el-option> -->
							</el-select>
						</el-form-item>
						<el-form-item>
				...
				>
					...
					<el-table-column label="授信余额" prop="amountCurrent" />
...
import { getMemberUserCreditLogUserPage } from '/@/api/member/priceAccount/creditAccount';
...
const state: BasicTableProps = reactive<BasicTableProps>({
	pageList: getMemberUserCreditLogUserPage,
	queryForm: {},
	dataList: [],
});
