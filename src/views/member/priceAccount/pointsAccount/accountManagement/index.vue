		...
		<div class="layout-padding" style="width: 100%">
			<div class="layout-padding-auto layout-padding-view">
				...
				<el-row class="mb8 flex justify-between items-center">
					<div>
						<el-button type="primary" icon="plus" @click="formDialogRef.openDialog()"> 调整积分 </el-button>
					</div>
				</el-row>
				<el-table
					:data="state.dataList"
				...
				>
					...
					<el-table-column label="积分余额" prop="score" />
					<el-table-column label="状态" prop="status">
						<template #default="scope">
							<el-tag v-if="scope.row.status == 1">正常</el-tag>
							<el-tag v-if="scope.row.status == 2">冻结</el-tag>
						</template>
					</el-table-column>
...
import { getAccountPage } from '/@/api/member/priceAccount/pointsAccount';
