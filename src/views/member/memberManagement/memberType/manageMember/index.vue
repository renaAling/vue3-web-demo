	...
	<div class="layout-padding" style="width: 100%">
		<div class="layout-padding-auto layout-padding-view">
				...
				<el-form :model="state.queryForm" ref="queryRef" :inline="true" @keyup.enter="getDataList">
					<el-row>
						<el-form-item label="所属分类" prop="categoryName">
							<el-select
								v-model="state.queryForm.categoryName"
								filterable
								remote
								clearable
								reserve-keyword
								...
								style="width: 240px"
							>
								<el-option v-for="item in categoryOptions" :key="item.categoryCode" :label="item.categoryName" :value="item.categoryName" />
							</el-select>
							<!-- <el-input placeholder="请输入所属分类" style="width: 220px" v-model="state.queryForm.categoryName" clearable /> -->
						</el-form-item>
			...
			>
				...
				<el-table-column prop="categoryNames" label="所属分类" show-overflow-tooltip> </el-table-column>
...
import { getMemberCategoryGetList } from '/@/api/member/memberType/typeManager';
