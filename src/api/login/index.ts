...
// 单点登录-免登
// export const loginByFree = (token: any, tenantId: any, tenantIdTarget: any) => {
// 	console.log('tenantIdTarget=============', tenantIdTarget);
// 	const grant_type = 'trusty_tenant';
// 	const scope = 'server';
// 	const basicAuth = 'Basic ' + window.btoa(import.meta.env.VITE_OAUTH2_MOBILE_CLIENT);
// 	Session.set('basicAuth', basicAuth);
...
// 			Authorization: basicAuth,
// 			'Content-Type': FORM_CONTENT_TYPE,
// 			'TENANT-ID': tenantIdTarget,
// 		},
// 		method: 'post',
// 		params: { grant_type, scope, originTenantId: tenantId, token },
// 	});
// };
export const loginByFree = (token: any, tenantId: any) => {
	const grant_type = 'trusty_tenant';
	const scope = 'server';
	const basicAuth = 'Basic ' + window.btoa(import.meta.env.VITE_OAUTH2_MOBILE_CLIENT);
	Session.set('basicAuth', basicAuth);
