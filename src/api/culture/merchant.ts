 ...
 * 商户分类 删除
 */
export function merchantCategoryDeleteApi(id: any) {
	return request({
 ...
 * 店铺类型 删除
 */
export function merchantTypeDeleteApi(id: any) {
	return request({
 ...
 * 商户 关闭
 */
export function merchantCloseApi(id: any) {
	return request({
 ...
 * 商户 详情
 */
export function merchantDetailApi(id: any) {
	return request({
 ...
 * 商户 开启
 */
export function merchantOpenApi(id: any) {
	return request({
 ...
 * 商户 推荐开关
 */
export function merchantSwitchApi(id: any) {
	return request({
 ...
 * @param data
 */
export function menuMerAdd(params: Object) {
	let systemMenuRequest = params;
	return request({
 ...
 * @param data
 */
export function menuMerDelete(id: any) {
	return request({
 ...
 * @param data
 */
export function menuMerInfo(id: any) {
	return request({
 ...
 * @param data
 */
export function menuMerUpdate(params: Object) {
	let systemMenuRequest = params;
	return request({
 ...
 * @param data
 */
export function menuMerUpdateShowStatus(params: Object) {
	return request({
 ...
 * @param data
 */
export function merApplyAuditApi(params: Object) {
	return request({
 ...
 * @param data
 */
export function merApplyRemarkApi(params: Object) {
	return request({
 ...
 * @param data
 */
export function merRsetPasswordApi(id: any) {
	return request({
 ...
 * @param data
 */
export function merCategoryListApi(params?: object) {
	return request({
 ...
 * @param pram
 */
export function storeCategoryAllApi(merId: any) {
	return request({
