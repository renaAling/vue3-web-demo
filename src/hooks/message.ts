...
export function useMessageBox() {
	class MessageBoxClass implements MessageImplements {
		...
		// 确认窗体
		confirm(msg: string, title?: string, confirmButton?: string) {
			return ElMessageBox.confirm(msg, title || t('message.box.title'), {
				confirmButtonText: confirmButton || t('common.confirmButtonText'),
		...
		// 一个按钮窗体
		alert(msg: string, title?: string, confirmButton?: string) {
			return ElMessageBox.alert(msg, title || t('message.box.title'), {
				confirmButtonText: confirmButton || t('common.confirmButtonText'),
				type: 'warning',
			});
		}
