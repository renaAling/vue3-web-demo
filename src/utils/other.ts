...
export function useTitle() {
	...
	nextTick(() => {
		const tenant = tenantConfig.value[currentTenantId];
		document.title = typeof tenant === 'object' && tenant !== null && 'name' in tenant
			? tenant.name
			: import.meta.env.VITE_GLOBAL_TITLE;
	});
}
 ...
 * @returns {*}
 */
export function downFileAddTask(url: any, query: any) {
