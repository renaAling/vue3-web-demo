...
const getThemeConfig = computed(() => {
	// console.log('themeConfig.value', themeConfig.value);
	// console.log('currentTenantId', currentTenantId);
	// if (currentTenantId == 1815608904948617218 || currentTenantId == 1857000132515905537) {
	// 	themeConfig.value.menuBar = '#3D495C';
	// 	themeConfig.value.menuBarColor = '#FFFFFF';
	// 	themeConfig.value.menuBarActiveColor = '#4785ea';
	// 	themeConfig.value.menuActiveColor = '#FFFFFF';
	// 	themeConfig.value.menuBarActiveColorC = '#FFFFFF';
	// } else if (isPortal.value) {
	// 	themeConfig.value.menuBarActiveColor = '#4785ea';
	// 	themeConfig.value.menuActiveColor = '#FFFFFF';
	// 	themeConfig.value.menuBarActiveColorC = '#FFFFFF';
	// } else {
	// 	themeConfig.value.menuBar = '#FFFFFF';
	// 	themeConfig.value.menuBarColor = '#4E5969';
	// 	themeConfig.value.menuBarActiveColor = '#F7F8FA';
	// }
...
const onBgColorPickerChange = (bg: string) => {
	...
	// if (bg === 'menuBarActiveColorC') {
	// 	document.documentElement.style.setProperty(`--next-color-menuBarActiveColor`, getLightColor(getThemeConfig.value.menuBarActiveColorC, 1));
	// }
	if (bg === 'menuActiveColor') {
		document.documentElement.style.setProperty(`--el-menu-active-color`, getLightColor(getThemeConfig.value.menuActiveColor, 1));
	}
...
const initLayoutChangeFun = () => {
	...
	onBgColorPickerChange('menuBarActiveColorC');
	onBgColorPickerChange('menuBarActiveColor');
	onBgColorPickerChange('menuActiveColor');
